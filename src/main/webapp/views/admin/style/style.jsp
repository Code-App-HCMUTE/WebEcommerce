                                    ...
                                    <div class="card p-0">
                                                ...
                                                <div
                                                    ...
                                                    <a href="style/add">
                                                        <button type="button"
                                                            ...
                                                            <i class="bx bx-plus me-1"></i> Thêm Kiểu
                                                        </button>
                                                    </a>
                                        ...
                                        <div class="table-responsive text-nowrap">
                                            <table class="table">
                                                ...
                                                <core:forEach items="${listStyles}" var="kq">
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    <a class="dropdown-item"
                                                                       href="/WebEcommerce/admin/style/edit?id=${kq.id}"><i
                                                                            class="bx bx-edit-alt me-1"></i>
                                                                        Edit</a>
                                                                    <a class="dropdown-item"
                                                                       href="/WebEcommerce/admin/style/delete?id=${kq.id}"><i

...
@WebServlet(name = "AddCommissionController", value = "/admin/commission/add")
public class AddCommissionController extends HttpServlet {
    CommissionService commissionService = new CommissionServiceImpl();
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {

        RequestDispatcher dispatcher = request.getRequestDispatcher("/views/admin/commission/addCommission.jsp");
        try {

...
public class HomeController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        float percentTransaction;
        if ((transactionService.sumMoneyTransaction(2021))==0 ){
            percentTransaction = 0;
        }
        else{
            percentTransaction =  (transaction - transactionService.sumMoneyTransaction(2021))/ (transactionService.sumMoneyTransaction(2021)) * 100;
        }

...
@WebServlet(name = "AddUserLevelController", value = "/admin/userLevel/add")
public class AddUserLevelController extends HttpServlet {
    UserLevelService userService =  new UserLevelServiceImpl();
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        RequestDispatcher dispatcher = request.getRequestDispatcher("/views/admin/user/addUserLevel.jsp");
        try {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            userService.insert(userLevelModel);

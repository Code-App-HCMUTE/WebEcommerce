        ...
        try {
            ...
            for (FileItem item : items) {
                if (item.getFieldName().equals("userId")) {
                    ...
                    order.setAmountFromUser(Double.parseDouble(item.getString("UTF-8")));
                } else if (item.getFieldName().equals("amountFromStore")) {
                    order.setAmountFromStore(Double.parseDouble(item.getString("UTF-8")));
                } else if (item.getFieldName().equals("amountToStore")) {
                    order.setAmountToStore(Double.parseDouble(item.getString("UTF-8")));
                } else if (item.getFieldName().equals("amountToGD")) {
                    order.setAmountToGD(Double.parseDouble(item.getString("UTF-8")));
                }
